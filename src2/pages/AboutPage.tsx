...
const BIRTH_DATE = new Date(1994, 2, 8);
// Year, Month (0-based → March = 2), Day
// 🔁 Change 1994 to the correct birth year
...
const aboutContent = [
  {
    title: "I am MaxBogey!",
    description: `As a ${getCurrentAge()}-year-old golf enthusiast from Norway, I was frustrated by expensive, fragmented golf apps. I wanted one platform for everything.`,
  },
  {
    title: "Building a Better App",
    description:
