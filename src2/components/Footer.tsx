        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-gray-500 text-sm">
              The ultimate golf companion. Premium features, completely for
              free.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-[250px]">
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/maxbogeygolf",
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://youtube.com/@maxbogey?si=Kso_fdLizTfhq06k",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/profile.php?id=61585787339174",
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.tiktok.com/@maxbogeygolf",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.snapchat.com/@maxbogeygolf",
              ...
              <div
                onClick={async () => {
                  try {
                    await navigator.clipboard.writeText("https://maxbogey.com");
                    setCopied(true);
                ...
                className="w-8 h-8 rounded-full bg-gray-800 hover:bg-amber-500 transition-colors cursor-pointer flex items-center justify-center relative"
              >
                <Share2 size={14} className="text-white" />

                {copied && (
                  <span className="absolute -top-8 text-xs bg-black text-white px-2 py-1 rounded-md shadow-lg whitespace-nowrap">
                    Link copied!
                  </span>
                )}
              </div>
