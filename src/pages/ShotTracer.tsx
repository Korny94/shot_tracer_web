        ...
        <div className="flex-1 relative flex items-center justify-center bg-zinc-950/50 p-4">
          ...
          >
            ...
            >
              <svg
                ref={svgRef}
                className="absolute inset-0 w-full h-full overflow-visible z-22"
              >
                <defs>
                  <filter
                    id="tracerDropShadow"
              ...
              >
                {showPlayerInfo ? (
                  ...
                  >
                    ...
                    {/* Lower Section: Par & Distance */}
                    <div className="bg-white px-2 pt-[4px] py-2 flex flex-col items-center">
                      {/* Par */}
